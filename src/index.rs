...
impl AddressIndex {
    ...
    pub fn search(&self, query_str: &str, limit: usize) -> Result<Vec<TantivyCandidate>, AppError> {
        ...
        let query = query_parser.parse_query(query_str).map_err(|e| AppError::bad_request(e.to_string()))?;
        ...
        for (_score, doc_address) in top_docs {
            ...
            results.push(TantivyCandidate {
                id: retrieved_doc.get_first(self.fields.id).and_then(|v| v.as_u64()).unwrap_or(0) as i64,
            });
        }
